          ...
          <div className="max-w-3xl pb-20">
            ...
            <div className="card p-5 sm:p-6 bg-subtle border-border mb-12">
              ...
              <p className="text-[14px] text-body leading-[1.8]">
                Our database of 1,000,000+ verified real estate agent contacts covers all 50 US states with name, email, phone, and state. Whether you&apos;re running cold email campaigns, building referral networks, or enriching your CRM — the data is the same. The strategy depends on who you are and what you sell.
              </p>
            </div>
