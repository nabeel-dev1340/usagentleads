...
## Leveraging Brokerages for Top-Down Sales
...
USAgentLeads gives PropTech sales teams the contact data they need to build targeted outbound pipelines. Our verified agent database covers all 50 states and is sourced directly from state licensing boards, delivered in CSV format with a one-time purchase model. Browse available data on our [states page](/states) and check [pricing](/pricing) to start building your agent prospect list today.
