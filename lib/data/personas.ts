...
export const PERSONAS: readonly Persona[] = [
    ...
    faqs: [
      {
        ...
        answer:
          "The full database includes 1,000,000+ contacts. Email coverage is near-complete, and roughly 40% of records include a direct phone number. The data is verified against state licensing records, so bounce rates stay low.",
      },
      {
  ...
  },
  {
    ...
    description:
      "You sell leads or build contact databases for clients who target real estate agents. The data sourcing is usually the most expensive and time-consuming part. Our pre-built database saves you the scraping, cleaning, and verification work — you get 1,000,000+ verified contacts ready to use or resell as part of your offering.",
    painPoints: [
    ...
    faqs: [
      {
        ...
        answer:
          "1,000,000+ licensed real estate agents across all 50 US states. Email coverage is near-complete. Approximately 40% of records include a direct phone number. Data is sourced from state licensing authorities.",
      },
      {
