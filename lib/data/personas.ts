  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "The database is refreshed regularly against state licensing records. Typical bounce rates run under 5%. For the freshest data, you can re-purchase periodically — at $99 for all 50 states, the cost is negligible compared to subscription-based alternatives.",
      },
      {
