...
export const COMPETITORS: readonly Competitor[] = [
  {
    ...
    features: [
      ...
      { feature: "Per-State Option", us: "$10/state", them: "Zone-based pricing" },
  ...
  },
  {
    ...
    features: [
      ...
      { feature: "Per-State Purchase", us: "$10/state", them: "Not available" },
  ...
  },
  {
    ...
    features: [
      ...
      { feature: "Per-State Pricing", us: "$10", them: "$20-50" },
